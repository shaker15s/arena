...
- 🎨 **رسومات فكتور جاهزة وعالية الجودة (unDraw Style)**: رسومات متجهة دقيقة مدمجة للشاشات والحالات الفارغة دون أي تعقيد يدوي في كود المسارات، مع توافق كامل عبر الويب والموبايل.
- 🎓 **إدارة كاملة للمركز**: فروع، لجان، كورسات، مجموعات (Batches)، جداول وجلسات مع تصدير تقارير المنظمة بصيغة CSV مشفرة UTF-8 BOM.
- 📋 **حضور ذكي وانصراف موثوق**: QR دوّار يتغيّر كل 25 ثانية (ضد التحايل)، كود احتياطي 6 أرقام، بصمة الجهاز (Device Fingerprint) لمنع التحضير بالإنابة، وتوثيق الانصراف الفعلي لحساب مدة البقاء.
- 🎮 **جيميفيكيشن واحتفالية دوولينجو**: نقاط، إكس بي أسبوعية، ستريك أسبوعي مع درع التجميد، دوري بـ 5 فئات، 12 شارة، كودوس المدرب، وشاشة احتفالية Duolingo-style عند إتمام المحاضرة بعداد تصاعدي ونبضات الستريك ومشاركة الإنجاز.
- 🏆 **شهادات قابلة للتحقق**: سيريال فريد + صفحة تحقق عامة بالـ QR ومسار إعادة إصدار وإلغاء إداري مدقق.
- 🎆 **حركات وتفاعلات دقيقة (2026)**: انفجار قصاصات الزينة الملونة (Confetti Explosion) وشريط تقدم بوميض ناعم (Shimmer Progress) وأرقام جدولية ثابتة (tabular-nums).
- 🧊 **Apple Liquid Glass** كثيم أساسي: ضبابية حقيقية مع بديل تدرجي ناعم للأندرويد، خلفيات متدرجة، لون التمايز الثانوي Amber (`#F59E0B`)، وأزرار 52pt قياسية.
